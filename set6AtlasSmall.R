...
context <- atCounts[,rownames(atInfo)[which(atInfo$ShortenedLifeStage3=="Ring" | atInfo$ShortenedLifeStage3=="Female" | atInfo$ShortenedLifeStage3=="Male" | atInfo$ShortenedLifeStage3=="Ookinete" | atInfo$ShortenedLifeStage3=="Oocyst")]]
...
intData <- RunUMAP(intData, dims = 1:14, verbose = FALSE)
intData <- FindNeighbors(intData, dims = 1:14, verbose = FALSE)
...
intData@meta.data$ShortLifeStage3[830:853] <- laterNames
class1 <- intData@meta.data$ShortLifeStage3
class1[848:853] <- "SET6-GAM"
class1[830:847] <- "SET6-OOK"

class2 <- intData@meta.data$ShortLifeStage3
class2[848:850] <- "SET6-KO.GAM"
class2[851:853] <- "SET6-WT.GAM"
class2[830:832] <- "SET6-KO.OOK08"
class2[833:835] <- "SET6-KO.OOK16"
class2[836:838] <- "SET6-KO.OOK24"
class2[839:841] <- "SET6-WT.OOK08"
class2[842:844] <- "SET6-WT.OOK16"
class2[845:847] <- "SET6-WT.OOK24"
...
DimPlot(setStuff2, reduction = "umap", group.by = "class1")
dev.off()
...
pcNumH <- pcNum/2
subCols <- c("#D62F1F", "#B30000", "#7E0000", "#2B8BBD", "#0768AC", "#074081", "#EE6447", "#4EB3D2")


class3 <- intData@meta.data$class2
class3[c(830:838, 848:850)] <- "KO"
class3[c(839:847, 851:853)] <- "WT"
